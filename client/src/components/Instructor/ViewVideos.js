...
return(
    ...
    "margin": "10px",
    "marginTop":"50px",
    "border-radius": "20px"}}><h1>{video.title}:</h1><h3>Total Hours: {video.totalHours}</h3><iframe width="700" height="350" src={'https://www.youtube.com/embed/'+video.url.split('=').at(1)} title={video.title} frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
            <br/><small>summary: {video.summary}</small></div>)}
