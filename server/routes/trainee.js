...
,getWallet,videoCount,sendCertificate,signUp,login,logout,userWatchVideo,getUser} from "../controllers/traineeController.js"
...
router.get('/getUser/:TraineeID/:CourseID', getUser);
